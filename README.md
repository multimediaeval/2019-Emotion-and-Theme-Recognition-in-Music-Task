...
## Baseline approach
We used a broadly used [vgg-ish architecture](https://arxiv.org/pdf/1606.00298.pdf) as our baseline. It consists of five 2D convolutional layers followed by a dense connection. Reproducible codes are available in [mtg-jamendo-dataset repository](https://github.com/MTG/mtg-jamendo-dataset). Our result after the training (1000 epoches) was:
